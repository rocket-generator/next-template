...
let authHandlers: ReturnType<typeof createHandlers> | undefined;
...
export function getBetterAuthHandler(): ReturnType<typeof createAuthInstance> {
  authInstance ??= createAuthInstance();
  return authInstance;
}

function createHandlers() {
  return toNextJsHandler(getBetterAuthHandler());
}

export function getHandlers(): ReturnType<typeof createHandlers> {
  authHandlers ??= createHandlers();
  return authHandlers;
}
